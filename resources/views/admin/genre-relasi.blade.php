        ...
        <div class="flex justify-between">
            ...
            <a href="{{ route('admin.genre') }}">
                <button
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/128/1950/1950630.png" alt=""
                            ...
                            <td class="px-2 py-4 flex justify-center items-center gap-3 border-r dark:border-gray-400">
                                @if ($items->isNotEmpty())
                                    <form id="delete-form-{{ $items->first()->id }}"
                                        ...
                                        @method('DELETE')
                                        <button type="button"
                                            class="text-white bg-red-600 flex justify-center hover:bg-red-700 mt-3 py-1 h-8 rounded w-14 delete-btn"
                                    ...
                                    <a
                                        href="{{ route('admin.edit-genre-relasi', ['id' => $items->first()->film->id_film]) }}">
                                        <button
                                            class="text-white bg-green-600 hover:bg-green-700 py-1 w-14 h-8 rounded px-4 flex justify-center">
                                            <img src="https://cdn-icons-png.flaticon.com/128/3597/3597088.png"
                                                alt="" class="w-5 h-5 filter invert">
                                        </button>
                                    </a>
                                @endif
                            </td>
