...
<body class="">
   ...
   <div class="">
    ...
    <form action="  {{ route('admin.edit-genre-relasi.update', $film->id_film) }}" method="POST" class="w-full bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="gap-5 flex justify-end">
           <a href="{{ route('admin.genre-relasi') }}">
            <button type="submit" class="w-20 bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 transition duration-200">
                Batal
            </button>
           </a>
            <button type="submit" class="w-20 bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition duration-200">
                Submit
            </button>
        </div>
    </form>
