...
<body>
    ...
    @section('navbar-admin')
        ...
        <div class="flex justify-between mb-3">
            ...
            <div class="flex gap-3">
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                    class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm h-12 w-12 flex justify-center items-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                    type="button">
                ...
                <!-- Dropdown menu -->
                <div id="dropdown"
                    class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-28 dark:bg-green-700">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200 text-center"
                        aria-labelledby="dropdownDefaultButton">
                        <li class="block px-4 py-2 dark:hover:bg-green-600 dark:hover:text-white">
                            Semua
                        </li>
                        @foreach ($user->pluck('role')->unique() as $role)
                            <li class="block px-4 py-2 dark:hover:bg-green-600 dark:hover:text-white">
                                {{ $role }}
                            </li>
                        @endforeach
        ...
        `,
            ...
            //filter dropdown
            document.addEventListener("DOMContentLoaded", function() {
                const filterItems = document.querySelectorAll("ul[aria-labelledby='dropdownDefaultButton'] li");
                const tableRows = document.querySelectorAll("tbody tr");
                    ...
                    item.addEventListener("click", function() {
                        ...
                        tableRows.forEach(row => {
                            ...
                            if (roleCell) {
                                ...
                                if (selectedRole === "Semua" || roleText === selectedRole) {
                                    row.style.display = "";
                                } else {
                                    row.style.display = "none";
                                }
