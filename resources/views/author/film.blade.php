                    ...
                    @foreach ($film as $film)
                        <tr class="border-b dark:border-gray-400">
                            ...
                            <td class="flex mt-3 justify-center items-center gap-3 border-r dark:border-gray-400">
                                ...
                                <button
                                    onclick="showEditFilmPopup('{{ route('author.edit-film.update', $film->id_film) }}', '{{ $film->judul }}', '{{ $film->pencipta }}', '{{ $film->deskripsi }}', '{{ $film->tahun_rilis }}', '{{ $film->durasi }}', '{{ $film->poster }}', '{{ $film->trailer }}', '{{ $film->kategori_umur }}')"
