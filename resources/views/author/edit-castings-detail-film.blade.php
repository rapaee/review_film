...
<head>
    ...
    <title>Edit Castings Detail Film</title>
...
<body class="">
    ...
    <form action="{{ route('author.edit-castings-detail-film.update', $casting->id_castings) }} " method="POST" class="w-full bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="gap-3 flex justify-end">
           <a href="{{ route('author.detail-film', ['id' => $casting->film->id_film]) }}">
