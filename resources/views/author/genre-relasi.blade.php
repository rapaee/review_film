        ...
        <tbody>
            ...
            <tr class="border-b dark:border-gray-400">
                ...
                <td class="px-2 py-4 flex justify-center items-center gap-3 border-r dark:border-gray-400">
                    @if ($items->isNotEmpty())
                        <form id="delete-form-{{ $items->first()->id }}" action="{{ route('author.genre-relasi.delete', $items->first()->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                        ...
                        <a href="{{ route('author.edit-genre-relasi', ['id' => $items->first()->film->id_film]) }}">
...
document.getElementById('openModal').addEventListener('click', function () {
    Swal.fire({
        ...
        html: `
          <form action="{{ route('author.genre-relasi.store') }}" method="POST" id="genreRelasiForm" class="text-left">
                @csrf
                <div class="mb-4">
